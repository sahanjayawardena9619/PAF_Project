	...
	<div>
		<div class="top-nav-bar">
			<form:form action="/paf_project/searchProductHome" method="POST">
				...
				<div class="menu-bar">
					<ul>
						<li><a href="/paf_project/viewAllCart"><i
								class="fas fa-shopping-cart" style="margin-right: 5px;"></i>Shopping
								Cart</a></li>
						<li><a href="/paf_project/login"><i class="fas fa-key"
			...
			<tfoot>
				...
				<tr>
					...
					<td colspan = "6" align="center">
							...
							<form:input type="text" hidden = "hidden" value = "${cartID}" path="cartID"/>
							<form:input type="text" hidden = "hidden" value = "${total}" path="total"/>
							
							<h5 style="color:gray;">Select Shipping Company</h5>
							<form:select path="shipID"  style="width:20%; border:solid 2px #007bff; margin-bottom:10px;">
				...
				<tr>
					<td colspan="6"><button type="submit" class="btn btn-success btn-block">Checkout
